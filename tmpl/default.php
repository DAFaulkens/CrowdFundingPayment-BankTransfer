...
if ($this->params->get("display_additional_info", 1)) {
    ...
    <p class="alert alert-info"><i class="icon-info-sign"></i><?php echo htmlspecialchars($additionalInfo, ENT_QUOTES, "UTF-8"); ?></p>;
    <?php } else { ?>
    <p class="alert alert-info"><i class="icon-info-sign"></i><?php echo JText::_($this->textPrefix . "_INFO"); ?></p>
    <?php } ?>
